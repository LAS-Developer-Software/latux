...
function getBuiltInExtensions() {
    ...
    for (const extension of [...builtInExtensions, ...webBuiltInExtensions]) {
        const configuredState = control[extension.name];
        let controlState = extension.path && (!configuredState || configuredState === 'marketplace')
            ? path.resolve(root, extension.path)
            : configuredState || 'marketplace';
